...
public: npc_globalclasstrainer() : CreatureScript("npc_globalclasstrainer") { }
        void MainMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_TRAINER, "[Reset specialization]", GOSSIP_SENDER_MAIN, 10002, "Do you really want to reset your specializations?", 0, false);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "[Reset talents]", GOSSIP_SENDER_MAIN, 10003);
